...
- `GET /api/friends` - Freundesliste abrufen ✅
  - Liefert für jeden Freund: Profilbild, Username, Profile-Title (Achievement), Total gespart, Streak (current/longest)
...
- `DELETE /api/friends/:id` - Freundschaft beenden ✅
  - Parameter: userId des Freundes (nicht friendshipId)
