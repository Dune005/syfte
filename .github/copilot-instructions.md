...
- Design: Figma (UI-Design, Prototyping, Clickflows)
  ...
  - **Design Specs:** Siehe auch `docs/Designkonzept.md` für Farbschema und Typography
...
- **Design-Änderungen:** Bei Frontend-Änderungen die mit Design/UI zu tun haben, immer zuerst `docs/Designkonzept.md` konsultieren
